    ...
    public static function defaults(): array {
        return [
            ...
            'inquiry_landlord' => [
                ...
                'html'      => "<h2>New inquiry</h2><p><strong>{{guest_name}}</strong> is interested in <a href=\"{{property_url}}\">{{listing_title}}</a> (ID {{property_id}}).</p><blockquote style=\"border-left:3px solid #ddd;padding-left:12px;color:#444\">{{inquiry_message}}</blockquote><p><a href=\"{{dashboard_url}}\">Reply from your dashboard</a></p>",
                'recipient' => 'user',
            ...
            'inquiry_guest' => [
                ...
                'html'      => "<h2>Thanks, {{guest_name}}!</h2><p>Your inquiry about <a href=\"{{property_url}}\">{{listing_title}}</a> has been sent to the owner, who will be in touch soon.</p>",
                'recipient' => 'user',
            ...
            'password_reset' => [
                ...
                'html'      => "<h2>Password reset</h2><p>We received a request to reset your password. Click below to choose a new one. If you didn't request this, you can ignore this email.</p><p><a href=\"{{reset_url}}\" style=\"display:inline-block;background:#006666;color:#fff;padding:10px 18px;border-radius:8px;text-decoration:none\">Reset password</a></p>",
                'recipient' => 'user',
            ...
            'subscription_purchase' => [
                ...
                'html'      => "<h2>Thank you for your purchase</h2><p>Your <strong>{{membership_name}}</strong> membership is now active. Amount paid: {{payment_amount}}.</p><p><a href=\"{{dashboard_url}}\" style=\"display:inline-block;background:#006666;color:#fff;padding:10px 18px;border-radius:8px;text-decoration:none\">Manage your membership</a></p>",
                'recipient' => 'user',
            ...
            'subscription_renewal' => [
                ...
                'html'      => "<h2>Membership renewed</h2><p>Your <strong>{{membership_name}}</strong> membership has renewed and is valid through {{expiration_date}}.</p>",
                'recipient' => 'user',
            ...
            'subscription_expiry' => [
                ...
                'html'      => "<h2>Your membership has expired</h2><p>Your <strong>{{membership_name}}</strong> membership has expired. Renew to keep your listings visible.</p><p><a href=\"{{dashboard_url}}\" style=\"display:inline-block;background:#006666;color:#fff;padding:10px 18px;border-radius:8px;text-decoration:none\">Renew now</a></p>",
                'recipient' => 'user',
            ...
            'review_submitted' => [
                ...
                'html'      => "<h2>New review submitted</h2><p>A new review for <strong>{{review_property}}</strong> is awaiting moderation.</p><p><a href=\"{{dashboard_url}}\">Moderate reviews</a></p>",
                'recipient' => 'admin',
            ...
            'review_approved' => [
                ...
                'html'      => "<h2>Your review is live</h2><p>Thank you — your review of <strong>{{review_property}}</strong> has been approved and is now public.</p>",
                'recipient' => 'user',
            ...
            'support_ticket_update' => [
                ...
                'html'      => "<h2>Support ticket update</h2><p>There's an update on your ticket <strong>#{{ticket_id}}</strong> — {{ticket_subject}}.</p><p><a href=\"{{dashboard_url}}\">View your ticket</a></p>",
                'recipient' => 'user',
            ...
            'review_request' => [
                ...
                'html'      => "<h2>We'd love your review</h2><p>Hi {{guest_name}}, thank you for staying at <strong>{{property_title}}</strong>. We'd love to hear about your experience — it only takes a minute.</p><p><a href=\"{{review_url}}\" style=\"display:inline-block;background:#006666;color:#fff;padding:10px 18px;border-radius:8px;text-decoration:none\">Write a review</a></p>",
                'recipient' => 'user',
            ...
            'payment_successful' => [
                ...
                'html'      => "<h2>Payment received</h2><p>Hi {{user_name}}, we've received your payment of <strong>{{payment_amount}}</strong> via {{payment_method}}.</p><p>Transaction reference: {{payment_id}}.</p>",
                'recipient' => 'user',
            ...
            'payment_failed' => [
                ...
                'html'      => "<h2>Payment failed</h2><p>Hi {{user_name}}, unfortunately your recent payment of {{payment_amount}} via {{payment_method}} could not be completed.</p><p>No charge was made. Please try again from your dashboard.</p>",
                'recipient' => 'user',
            ...
            'listing_submitted' => [
                ...
                'html'      => "<h2>New listing submitted</h2><p><strong>{{owner_name}}</strong> submitted a new listing: <a href=\"{{property_url}}\">{{listing_title}}</a> (ID {{property_id}}).</p><p><a href=\"{{dashboard_url}}\">Review in the admin</a></p>",
                'recipient' => 'admin',
            ...
            'listing_approved' => [
                ...
                'html'      => "<h2>Your listing is live</h2><p>Good news, {{owner_name}} — your listing <a href=\"{{property_url}}\">{{listing_title}}</a> has been approved and is now visible to renters.</p>",
                'recipient' => 'user',
            ...
            'listing_rejected' => [
                ...
                'html'      => "<h2>Your listing needs changes</h2><p>Hi {{owner_name}}, your listing <a href=\"{{property_url}}\">{{listing_title}}</a> wasn't approved. {{reject_reason}}</p><p><a href=\"{{dashboard_url}}\">Edit your listing</a></p>",
                'recipient' => 'user',
            ...
            'listing_deleted' => [
                ...
                'html'      => "<h2>Your listing was removed</h2><p>Hi {{owner_name}}, your listing <strong>{{listing_title}}</strong> (ID {{property_id}}) has been deleted. If this was a mistake, contact support.</p>",
                'recipient' => 'user',
            ...
            'support_ticket_created' => [
                ...
                'html'      => "<h2>New support ticket</h2><p><strong>#{{ticket_id}}</strong> — {{ticket_subject}}</p><p>From: {{user_name}} ({{user_email}})</p><p>{{ticket_message}}</p><p><a href=\"{{dashboard_url}}\">Open in the admin</a></p>",
                'recipient' => 'admin',
            ...
            'support_ticket_reply' => [
                ...
                'html'      => "<h2>New reply on ticket #{{ticket_id}}</h2><p>Our team replied to <strong>{{ticket_subject}}</strong>:</p><blockquote style=\"border-left:3px solid #ddd;padding-left:12px;color:#444\">{{ticket_message}}</blockquote><p><a href=\"{{dashboard_url}}\">View your ticket</a></p>",
                'recipient' => 'user',
            ...
            'contact_form' => [
                ...
                'html'      => "<h2>New contact message</h2><p>From <strong>{{sender_name}}</strong> ({{sender_email}}):</p><blockquote style=\"border-left:3px solid #ddd;padding-left:12px;color:#444\">{{contact_message}}</blockquote>",
                'recipient' => 'admin',
                'vars'      => [ 'sender_name', 'sender_email', 'contact_message', 'site_name', 'site_url' ],
            ],
            'email_verification' => [
                'name'      => __( 'Confirm Your Email', 'ovr-core' ),
                'subject'   => __( 'Please confirm your email for {{site_name}}', 'ovr-core' ),
                'html'      => "<h2>Confirm your email</h2><p>Hi {{user_name}}, thanks for creating a {{site_name}} account. Please confirm this address is yours so we can secure your account.</p><p><a href=\"{{verify_url}}\" style=\"display:inline-block;background:#006666;color:#fff;padding:10px 18px;border-radius:8px;text-decoration:none\">Verify my email</a></p><p>If the button doesn't work, copy this link into your browser: {{verify_url}}</p>",
                'recipient' => 'user',
