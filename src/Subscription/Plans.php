    ...
    public static function get_default_plans(): array {
        return [
            'base_subscriber' => [
                ...
                'max_listings'  => 1,
                'is_popular'    => false,
                'description'   => __( 'Perfect for getting started. Max 1 listing.', 'ovr-core' ),
                'features'      => [
                    __( '1 Property Listing', 'ovr-core' ),
                    __( 'Standard Support', 'ovr-core' ),
                    __( 'Basic Analytics', 'ovr-core' ),
                ],
                'sort_order'    => 1,
                'is_active'     => true,
            ],
